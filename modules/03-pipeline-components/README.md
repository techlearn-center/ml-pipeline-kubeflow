# Module 03: Pipeline Components and Containers
...
- Understand the core concepts of Pipeline Components and Containers
...
### What is Pipeline Components and Containers?

Pipeline Components and Containers is a fundamental component of ML Pipeline with Kubeflow: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Pipeline Components and Containers like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/03-pipeline-components/
```
...
```bash
ls modules/03-pipeline-components/lab/starter/
```
...
cd modules/03-pipeline-components/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/03-pipeline-components/validation/validate.sh
```
...
1. What is the main purpose of Pipeline Components and Containers?
...
- [ ] Validation script passes: `bash modules/03-pipeline-components/validation/validate.sh`
...
**Next: [Module 04 →](../04-data-processing-steps/)**
