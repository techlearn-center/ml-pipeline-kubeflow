# Module 09: Metadata and Data Lineage
...
- Understand the core concepts of Metadata and Data Lineage
...
### What is Metadata and Data Lineage?

Metadata and Data Lineage is a fundamental component of ML Pipeline with Kubeflow: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Metadata and Data Lineage like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/09-metadata-and-lineage/
```
...
```bash
ls modules/09-metadata-and-lineage/lab/starter/
```
...
cd modules/09-metadata-and-lineage/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/09-metadata-and-lineage/validation/validate.sh
```
...
1. What is the main purpose of Metadata and Data Lineage?
...
- [ ] Validation script passes: `bash modules/09-metadata-and-lineage/validation/validate.sh`
...
**Next: [Module 10 →](../10-production-kubeflow/)**
