# Module 08: Pipeline Scheduling and Triggers
...
- Understand the core concepts of Pipeline Scheduling and Triggers
...
### What is Pipeline Scheduling and Triggers?

Pipeline Scheduling and Triggers is a fundamental component of ML Pipeline with Kubeflow: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Pipeline Scheduling and Triggers like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/08-pipeline-scheduling/
```
...
```bash
ls modules/08-pipeline-scheduling/lab/starter/
```
...
cd modules/08-pipeline-scheduling/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/08-pipeline-scheduling/validation/validate.sh
```
...
1. What is the main purpose of Pipeline Scheduling and Triggers?
...
- [ ] Validation script passes: `bash modules/08-pipeline-scheduling/validation/validate.sh`
...
**Next: [Module 09 →](../09-metadata-and-lineage/)**
