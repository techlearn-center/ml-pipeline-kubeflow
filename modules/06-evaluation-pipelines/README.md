# Module 06: Model Evaluation Pipelines
...
- Understand the core concepts of Model Evaluation Pipelines
...
### What is Model Evaluation Pipelines?

Model Evaluation Pipelines is a fundamental component of ML Pipeline with Kubeflow: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Model Evaluation Pipelines like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/06-evaluation-pipelines/
```
...
```bash
ls modules/06-evaluation-pipelines/lab/starter/
```
...
cd modules/06-evaluation-pipelines/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/06-evaluation-pipelines/validation/validate.sh
```
...
1. What is the main purpose of Model Evaluation Pipelines?
...
- [ ] Validation script passes: `bash modules/06-evaluation-pipelines/validation/validate.sh`
...
**Next: [Module 07 →](../07-deployment-pipelines/)**
